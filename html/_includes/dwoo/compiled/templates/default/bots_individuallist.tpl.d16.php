...
?> last<?php 
}?>" botpack="<?php echo htmlspecialchars((isset($this->scope["bot"]["number"]) ? $this->scope["bot"]["number"]:null), (defined("ENT_QUOTES") ? ENT_QUOTES : null));?>" >
  <td class="batch"><input type="checkbox" name="batch" onclick="document.stopEvents=true" /></td>
  <td class="name"><a href="?id=<?php echo urlencode((isset($this->scope["bot"]["botId"]) ? $this->scope["bot"]["botId"]:null));?>"><?php echo htmlspecialchars($this->readVar("botnames.".(isset($this->scope["bot"]["botId"]) ? $this->scope["bot"]["botId"]:null)));?></a></td>
  ...
  <a href="?search=<?php echo urlencode((isset($this->scope["bot"]["name"]) ? $this->scope["bot"]["name"]:null));?>" class="link" onclick="document.stopEvents=true" title="Find out what other bots have this file">[s]</a></td>
</tr>
<?php 
/* -- foreach end output */
	}
